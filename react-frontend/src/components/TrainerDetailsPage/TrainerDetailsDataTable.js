...
const TrainerDetailsDataTable = ({
  ...
  const pTemplate0 = (rowData, { rowIndex }) => (
    <p>{rowData.trainerIcPassportNumber}</p>
  );
  ...
  return (
    <>
      ...
      >
        <Column
          field="trainerIcPassportNumber"
          header="Trainer IC/Passport Number"
          body={pTemplate0}
          filter={selectedFilterFields.includes("trainerIcPassportNumber")}
          hidden={selectedHideFields?.includes("trainerIcPassportNumber")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          body={pTemplate2}
          filter={selectedFilterFields.includes("employmentType")}
          hidden={selectedHideFields?.includes("employmentType")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
      ...
      <Dialog
        header="Upload TrainerDetails Data"
        visible={showUpload}
