...
const TrainerDetailsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            trainerIcPassportNumber: _entity?.trainerIcPassportNumber,organizationName: _entity?.organizationName,employmentType: _entity?.employmentType,nationality: _entity?.nationality,
