...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Organization Contact Number</label><p className="m-0 ml-3" >{_entity?.organizationContactNumber}</p></div>
